...
function Track() {
    ...
    const [TrackTillRefurbishing, showTrackTillRefurbished] = useState(false);
    const [TrackTillRemanufacturing, showTrackTillRemanufactured] = useState(false);
    const [TrackTillRegenerating, showTrackTillRegenerated] = useState(false);
    const [TrackTillReturned, showTrackTillReturned] = useState(false);
    ...
    const loadBlockchaindata = async () => {
        ...
        if (networkData) {
            ...
            setRET(ret);
            const strCtr = await supplychain.methods.strCtr().call();
            const str = {};
            for (i = 0; i < strCtr; i++) {
                str[i+1] = await supplychain.methods.STR(i+1).call();
            }
            setSTR(str);
            setloader(false);
        }
        ...
        return (
            <div className="container mt-4">
                ...
                <ul className="timeline">
                    ...
                    <li className="timeline-item">
                        <div className="card">
                            <div className="card-header"><h4><u>Returned to:</u></h4></div>
                            <div className="card-body">
                                <p><b>Retailer ID:</b> {RET[MED[ID].RETid].id}</p>
                                <p><b>Name:</b> {RET[MED[ID].RETid].name}</p>
                                <p><b>Place:</b> {RET[MED[ID].RETid].place}</p>
                    ...
                    <li className="timeline-item">
                        <div className="card">
                            <div className="card-header"><h4><u>STR Center:</u></h4></div>
                            <div className="card-body">
                                {/* <p><b>STR ID:</b> {STR[MED[ID].STRid].id}</p>
                                <p><b>Name:</b> {STR[MED[ID].STRid].name}</p>
                                <p><b>Place:</b> {STR[MED[ID].STRid].place}</p> */}
                                <p><b>STR ID:</b> 1</p>
                                <p><b>Name:</b> STR 1</p>
                    ...
                    <li className="timeline-item">
                        <div className="card">
                            <div className="card-header"><h4><u>STR</u></h4></div>
                            <div className="card-body">
                                <p>Status: Sent for Refurbishing</p>
                            </div>
                        </div>
                    </li>
                </ul>
                ...
                <div className="d-flex justify-content-between mt-4">
                    <button onClick={() => showTrackTillRefurbished(false)} className="btn btn-outline-success btn-sm">Track Another Item</button>
    ...
    if (TrackTillRemanufacturing) {
        return (
            <div className="container mt-4">
                ...
                <ul className="timeline">
                    ...
                    <li className="timeline-item">
                        <div className="card">
                            <div className="card-header"><h4><u>STR</u></h4></div>
                            <div className="card-body">
                                <p>Status: Sent for Remanufacturing</p>
                            </div>
                        </div>
                    </li>
                </ul>
                ...
                <div className="d-flex justify-content-between mt-4">
                    <button onClick={() => showTrackTillRemanufactured(false)} className="btn btn-outline-success btn-sm">Track Another Item</button>
                    <button onClick={() => history.push('/')} className="btn btn-outline-danger btn-sm">HOME</button>
                </div>
            </div>
        )
        ...
        return (
            <div className="container mt-4">
                ...
                <ul className="timeline">
                    ...
                    <li className="timeline-item">
                        <div className="card">
                            <div className="card-header"><h4><u>Returned</u></h4></div>
                            <div className="card-body">
                                <p>Status: Returned</p>
                            </div>
                        </div>
                ...
                <div className="d-flex justify-content-between mt-4">
                    <button onClick={() => showTrackTillReturned(false)} className="btn btn-outline-success btn-sm">Track Another Item</button>
                    <button onClick={() => history.push('/')} className="btn btn-outline-danger btn-sm">HOME</button>
                </div>
            </div>
        )
    ...
    const handlerSubmit = async (event) => {
        ...
        if (!((ID > 0) && (ID <= ctr)))
            ...
            if(MED[ID].stage == 8)
                showTrackTillRefurbished(true);
            //eslint-disable-next-line
            if (MED[ID].stage == 7)
                showTrackTillRemanufactured(true);
            //eslint-disable-next-line
            else if (MED[ID].stage == 6)
                showTrackTillReturned(true);
            // eslint-disable-next-line
            else if (MED[ID].stage == 5)
